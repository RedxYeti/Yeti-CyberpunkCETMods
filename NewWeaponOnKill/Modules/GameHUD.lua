...
function GameHUD.ShowWarning(text, duration, type)
    if text == nil or text == "" then
        return
    end

    --type added by me, not all of them work and the ones that do mostly look like negative
    --notable ones are apartment, relic, and money
    --Undefined = 0
    --Negative = 1
    --Neutral = 2
    --Vehicle = 3
